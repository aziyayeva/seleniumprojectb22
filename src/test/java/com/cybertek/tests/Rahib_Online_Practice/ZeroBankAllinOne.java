...
public class ZeroBankAllinOne {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.linkText("Transfer Funds")).click(); // this uses the actual Text

        Thread.sleep(1000);
        //* 9. Locate From Account and Choose the Savings account with "$ 1548"
        driver.findElement(By.id("tf_fromAccountId"));

        WebElement dropDownMenuSave = driver.findElement(By.id("tf_fromAccountId"));
        dropDownMenuSave.click();

        Thread.sleep(1000);
        Select savings = new Select(dropDownMenuSave); // Select is another class that needs to be imported
